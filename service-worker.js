import { config } from "./package_d931a676f54434b166bae34505a2cd089c69c7db/uno-config.js";
...
if (config.environmentVariables["UNO_BOOTSTRAP_DEBUGGER_ENABLED"] !== "True") {
    ...
    self.addEventListener('install', function (e) {
        ...
        e.waitUntil(
            caches.open('package_d931a676f54434b166bae34505a2cd089c69c7db').then(async function (cache) {
